...
from .mesoSPIM_Stages import mesoSPIM_PI_1toN, mesoSPIM_PI_NtoN, mesoSPIM_ASI_Tiger_Stage, mesoSPIM_ASI_MS2000_Stage, mesoSPIM_ASI_MS2000_Stage_B067, mesoSPIM_DemoStage, mesoSPIM_PI_rotz_and_Galil_xyf_Stages
    ...
    * **Zoom** — one of the :class:`DynamixelZoom` / :class:`MitutoyoZoom` /
    ...
    def __init__(self, parent):
        ...
        #     self.stage = mesoSPIM_PI_rotzf_and_Galil_xy_Stages(self)
            ...
            self.stage.sig_pause.connect(self.pause)
            self.parent.sig_progress.connect(self.stage.log_slice)
        elif self.cfg.stage_parameters['stage_type'] == 'MS2000ASI_B067':
            self.stage = mesoSPIM_ASI_MS2000_Stage_B067(self)
            self.stage.sig_pause.connect(self.pause)
            self.parent.sig_progress.connect(self.stage.log_slice)
