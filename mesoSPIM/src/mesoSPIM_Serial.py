...
from .mesoSPIM_Stages import mesoSPIM_PI_1toN, mesoSPIM_PI_NtoN, mesoSPIM_PI_NtoN_piezo, mesoSPIM_ASI_Tiger_Stage, mesoSPIM_ASI_MS2000_Stage, mesoSPIM_DemoStage, mesoSPIM_GalilStages, mesoSPIM_PI_f_rot_and_Galil_xyz_Stages, mesoSPIM_PI_rot_and_Galil_xyzf_Stages, mesoSPIM_PI_rotz_and_Galil_xyf_Stages, mesoSPIM_PI_rotzf_and_Galil_xy_Stages
...
class mesoSPIM_Serial(QtCore.QObject):
    ...
    def __init__(self, parent):
        ...
        elif self.cfg.stage_parameters['stage_type'] in 'PI_NcontrollersNstagesPiezo':
            self.stage = mesoSPIM_PI_NtoN_piezo(self)    
